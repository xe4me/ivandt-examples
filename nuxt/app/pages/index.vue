...
:root:not([data-theme]) ivt-importer {
  --ivt-color-base-100: oklch(98% 0.002 247.839);
  --ivt-color-base-200: oklch(96% 0.003 264.542);
  --ivt-color-base-300: oklch(92% 0.006 264.531);
...
:root[data-theme='dark'] ivt-importer {
  --ivt-color-base-100: oklch(18% 0.008 264.665);
  --ivt-color-base-200: oklch(22% 0.012 264.665);
  --ivt-color-base-300: oklch(28% 0.016 264.665);
